...
const INITIAL_KEYS: AccessKey[] = [
    ...
    { id: '4', key: 'MIT_ROOT_SECURE_2024_X', role: 'ADMIN', status: 'ACTIVE', createdAt: new Date(2024,0,1).toISOString(), expiresAt: new Date(2099,11,31).toISOString(), owner: 'SİSTEM ROOT', email: 'root@system.local', lastLogin: new Date().toISOString(), usageCount: 0 },
];
